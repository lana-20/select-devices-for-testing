...
- Checking which Android OS versions support Bluetooth ➦ Discovering that [Android Jelly Bean v4.3 and above (minSDK/API Level 18+) supports Bluetooth](https://github.com/lana-20/select-devices-for-testing/blob/main/Screenshot%202023-01-17%20at%208.56.06%20PM.png) and that [migration to Android 12 may encounter new restrictions on the Bluetooth/Telephony side](https://www.droidcon.com/2022/06/28/one-does-not-simply-migrating-to-android-12/).
